...
/* floating decorative orbs — pure CSS, no JS, purely visual depth */
.hero-orb {
    position: absolute;
    border-radius: 50%;
    filter: blur(2px);
...
.hero-orb-1 {
    ...
    background: radial-gradient(circle, rgba(201,151,62,0.35) 0%, transparent 70%);
    top: -60px; right: -60px;
}
.hero-orb-2 {
    width: 260px; height: 260px;
    background: radial-gradient(circle, rgba(244,241,232,0.12) 0%, transparent 70%);
