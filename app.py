...
def _auth_hero():
    st.markdown(
        ...
        <div class="auth-hero">
            ...
            <div class="hero-tag">Inventory &amp; Sales, Ledger-Simple</div>
            <div class="hero-line"><span class="dot">•</span>
                Track stock in real time, right down to the last unit.</div>
            <div class="hero-line"><span class="dot">•</span>
                Scan barcodes to restock or add new items in seconds.</div>
            <div class="hero-line"><span class="dot">•</span>
                See what's selling with clean, simple dashboards.</div>
            <div class="hero-line"><span class="dot">•</span>
                Export a clean Excel report whenever you need one.</div>
            <div class="hero-receipt">
                GROUP 47 · R.C. TECHNICAL INSTITUTE, AHMEDABAD<br/>
