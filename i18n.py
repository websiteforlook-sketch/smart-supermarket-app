...
TRANSLATIONS = {
    ...
    "tab_remove_product": {"en": "Remove product", "gu": "ઉત્પાદન દૂર કરો"},
    ...
    "photo_url_optional": {"en": "Product photo URL (optional — leave blank to auto-match one)",
                            "gu": "ઉત્પાદનના ફોટાની URL (વૈકલ્પિક — ખાલી રાખશો તો આપોઆપ મેળવાશે)"},
    "photo_url_help": {"en": "Paste a direct link to override the auto-matched illustration.",
                        "gu": "આપોઆપ મળેલ ચિત્ર બદલવા માટે સીધી લિંક પેસ્ટ કરો."},
    ...
    "scan_method_manual": {"en": "USB scanner / type", "gu": "USB સ્કેનર / ટાઈપ કરો"},
    "scan_method_camera": {"en": "Photo from gallery", "gu": "ગેલેરીમાંથી ફોટો"},
    ...
    "tab_add_by_photo": {"en": "Add by photo", "gu": "ફોટોથી ઉમેરો"},
    ...
    # ---- Remove product tab ----
    "remove_product_title": {"en": "Remove a product", "gu": "ઉત્પાદન દૂર કરો"},
    "remove_select_product": {"en": "Select product to remove", "gu": "દૂર કરવા માટે ઉત્પાદન પસંદ કરો"},
    "remove_confirm_checkbox": {
        "en": "I understand this will permanently delete this product and its sales history.",
        "gu": "હું સમજું છું કે આ ઉત્પાદન અને તેનો વેચાણ ઇતિહાસ કાયમ માટે ડિલીટ થશે.",
    },
    "remove_button": {"en": "Remove product", "gu": "ઉત્પાદન દૂર કરો"},
